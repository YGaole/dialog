...
\begin{figure}[H]
\centering
\subfigure[利用Breit-Wigner分布拟合提取的$V_{1p1n}(Z,N)$对力的分布.\label{fig_V1p1npairs}]{
\includegraphics[width=0.4\textwidth]{figure/V1p1npairs.pdf}}
\qquad
\subfigure[GKL公式的计算值的统计分布.\label{fig_GKL}]{\includegraphics[width=0.4\textwidth]{figure/GKL.pdf}}
% \caption{对AME2016和FRDM模型的奇A核和偶A核的$V_{1p-1n}(Z,N)$相互作用的统计分布进行的高斯拟合.\label{fig_FRDMexpV1p1nt}}
\end{figure}
