...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{oV1p1n.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{zV1n1ne.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{expVPn50eN.pdf}
\caption{偶N核的最外层配对核子之间的相互作用在核素图中的分布.\label{fig_expVPn50eN}}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{oV1n1n.pdf}
